...
export default function AdminUsuariosYCuentasScreen() {
    ...
    const styles = StyleSheet.create({
      ...
      itemActions: { flexDirection: 'row', marginLeft: 12 },
      actionButton: { paddingHorizontal: 10, paddingVertical: 6, borderRadius: 6, marginLeft: 8, borderWidth: 1, borderColor: '#2196F3' },
      deleteBtn: { backgroundColor: '#e53935', borderColor: '#e53935' },
      actionText: { color: '#2196F3', fontWeight: '700' },
    
      modalWrap: { flex: 1, justifyContent: 'center', backgroundColor: 'rgba(0,0,0,0.4)', padding: 20 },
      modal: { backgroundColor: '#fff', borderRadius: 8, padding: 16 },
      modalTitle: { fontSize: 18, fontWeight: '700', marginBottom: 12 },
      input: { borderWidth: 1, borderColor: '#ddd', borderRadius: 6, padding: 10, marginBottom: 12, backgroundColor: '#fff' },
